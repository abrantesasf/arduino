...
\begin{itemize}
  \item \textbf{Alimentação}: a lista a seguir e a
        ...
        \label{fig:fonte9v}
        \vspace{-0.2cm}
        \includegraphics[scale=0.7]{imagens/alimentacao2.jpeg}
        %\footnotesize{Fonte: xxx}
        \end{figure}
  \item \textbf{Microcontrolador}: precisaremos dos materiais ilustrados na
        lista abaixo e na figura~\ref{fig:atmega328p} a seguir:
        \begin{itemize}
        ...
        \begin{figure}[H]
        \centering
        \caption{ATmega328P-PU}
        \label{fig:atmega328p}
        \vspace{-0.2cm}
        \includegraphics[scale=0.9]{imagens/microcontrolador.jpeg}
        %\footnotesize{Fonte: xxx}
        \end{figure}
        \end{itemize}
  \item \textbf{Clock}: para montar o circuito de clock precisamos dos materiais
        a seguir (ilustrados na Figura~\ref{fig:clock}):
        \begin{itemize}[noitemsep]
...
multímetro para verificar tensões:
